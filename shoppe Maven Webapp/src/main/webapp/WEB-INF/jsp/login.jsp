					...
					<div class="row">
						<div class="col-sm-6 col-sm-offset-3">
							<div class="box p-40 p-xs-20 bg-white">
								<form action="/shoppe/user/isLogin">
									<div class="form-group">
										<label class="control-label" for="input-email">Phone</label>
										<input type="text" name="uphone" value="" placeholder="Phone" id="input-phone" class="form-control form-item">
									</div>
									...
									<button type="submit" class="btn ht-btn bg-6">Login</button>
