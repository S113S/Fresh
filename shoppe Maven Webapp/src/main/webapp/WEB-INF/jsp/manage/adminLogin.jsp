...
<style>
body{width:100%;height:100%;overflow:hidden;background:url(./../htgl/images/pc_loginBg.jpg) no-repeat;background-size:cover;position:absolute;}
</style>
...
<body>
  <section class="loginform">
   <h1>后台管理系统</h1>
   <form action="/shoppe/admin/isAdminLogin">
   <ul>
    <li>
     <label>账号：</label>
