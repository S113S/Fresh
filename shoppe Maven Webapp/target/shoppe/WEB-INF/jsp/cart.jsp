							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a href="#collapse0" data-toggle="collapse" data-parent="#accordion" class="accordion-toggle" aria-expanded="true">购物车
									...
									<div class="panel-body">
												...
												<div>
													<div class="table-div">
														...
														<div class="row m-0 table-content ee">
															...
															<div class="col col-xs-2" style="padding-top:25px">
																<a href="#"></a>
																<div class="gw_num input-group btn-block" style="margin:0 auto">
																   <em class="jian" onclick="del(this,${c.product.pid },${user.uid })">-</em>
																   <input type="text" value="${c.num }" class="num"/>
																   <em class="add" onclick="add(this,${c.product.pid },${user.uid })">+</em>
																</div>
															</div>
										...
										<div class="buttons m-t-30">
											<div class="pull-right">
												<a href="/shoppe/order/newOrder" class="btn ht-btn bg-6">确认购物车</a>
											</div>
										</div>
									</div>
								</div>
...
<script type="text/javascript">
	...
	function ctotal(){
		...
		$("div.ee").each(function(){
			...
			var num=$(this).children("div").eq(3).children("div").children("input").val();
	...
	function add(e,pid,uid){
		$.ajax({
			...
			success:function(msg){
				...
				var price=$(e).parent().parent().next().children("span").text();
				var ordsum=$("#ordsum").children("span").text();
				$(e).prev().val(num);
				$(e).parent().parent().next().next().text("$"+price*num);
				$("#ordsum").children("span").text(parseInt(ordsum)+parseInt(price));
				if(num==0){ $(e).parent().parent().parent().hide();}
			}
		});
	} 
	
	//删除购物车
	function del(e,pid,uid){
		$.ajax({
			async:false,
			url:"/shoppe/car/del",
			dataType:"json",
